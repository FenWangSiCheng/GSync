...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i648.OAuthBrowserLauncher>(
      () => registerModule.oAuthBrowserLauncher(),
    );
    ...
    gh.lazySingleton<_i594.GitHubOAuthApi>(
      () => registerModule.gitHubOAuthApi(gh<_i519.Client>()),
    );
    gh.lazySingleton<_i361.Dio>(
      () => registerModule.dio(gh<_i542.DioClient>()),
    );
    gh.lazySingleton<_i398.GitHubOAuthRedirectRepository>(
      () => registerModule.gitHubOAuthRedirectRepository(
        gh<_i531.AppConfig>(),
        gh<_i594.GitHubOAuthApi>(),
        gh<_i648.OAuthBrowserLauncher>(),
      ),
    );
    ...
    gh.lazySingleton<_i832.StartGitHubOAuthRedirectAuthorization>(
      () => registerModule.startGitHubOAuthRedirectAuthorization(
        gh<_i398.GitHubOAuthRedirectRepository>(),
      ),
    );
    gh.lazySingleton<_i1014.CompleteGitHubOAuthRedirectAuthorization>(
      () => registerModule.completeGitHubOAuthRedirectAuthorization(
        gh<_i398.GitHubOAuthRedirectRepository>(),
      ),
    );
    ...
    gh.factory<_i312.TokenSettingsBloc>(
      () => registerModule.tokenSettingsBloc(
        ...
        gh<_i832.StartGitHubOAuthRedirectAuthorization>(),
        gh<_i1014.CompleteGitHubOAuthRedirectAuthorization>(),
      ),
    );
    return this;
  }
