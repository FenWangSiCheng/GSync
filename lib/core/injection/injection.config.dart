...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i78.DirectoryAccessScope>(
      () => registerModule.directoryAccessScope(),
    );
    ...
    gh.lazySingleton<_i241.GitHubRepositoryCatalogApi>(
      () => registerModule.gitHubRepositoryCatalogApi(gh<_i519.Client>()),
    );
    gh.lazySingleton<_i798.GitHubDeviceFlowApi>(
      () => registerModule.gitHubDeviceFlowApi(gh<_i519.Client>()),
    );
    ...
    gh.lazySingleton<_i451.GitSyncRepository>(
      () => registerModule.gitSyncRepository(
        ...
        gh<_i78.DirectoryAccessScope>(),
      ),
    );
    gh.lazySingleton<_i366.GitHubRepositoryCatalogRepository>(
      () => registerModule.gitHubRepositoryCatalogRepository(
        gh<_i531.AppConfig>(),
        gh<_i241.GitHubRepositoryCatalogApi>(),
      ),
    );
    ...
    gh.lazySingleton<_i544.GitHubDeviceFlowRepository>(
      () => registerModule.gitHubDeviceFlowRepository(
        gh<_i531.AppConfig>(),
        gh<_i798.GitHubDeviceFlowApi>(),
      ),
    );
    ...
    gh.lazySingleton<_i1024.LoadGitHubRepositories>(
      () => registerModule.loadGitHubRepositories(
        gh<_i366.GitHubRepositoryCatalogRepository>(),
      ),
    );
    gh.lazySingleton<_i734.LoadGitHubRepositoryBranches>(
      () => registerModule.loadGitHubRepositoryBranches(
        gh<_i366.GitHubRepositoryCatalogRepository>(),
      ),
    );
    gh.lazySingleton<_i166.RequestGitHubDeviceAuthorization>(
      () => registerModule.requestGitHubDeviceAuthorization(
        gh<_i544.GitHubDeviceFlowRepository>(),
      ),
    );
    gh.lazySingleton<_i383.PollGitHubDeviceToken>(
      () => registerModule.pollGitHubDeviceToken(
        gh<_i544.GitHubDeviceFlowRepository>(),
      ),
    );
    gh.factory<_i745.DirectorySyncBloc>(
      () => registerModule.directorySyncBloc(
        ...
        gh<_i1024.LoadGitHubRepositories>(),
        gh<_i734.LoadGitHubRepositoryBranches>(),
      ),
    );
    gh.factory<_i312.TokenSettingsBloc>(
      () => registerModule.tokenSettingsBloc(
        ...
        gh<_i166.RequestGitHubDeviceAuthorization>(),
        gh<_i383.PollGitHubDeviceToken>(),
      ),
    );
    return this;
  }
