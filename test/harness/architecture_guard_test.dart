...
void main() {
  group('Harness structure', () {
    ...
    test('feature list is valid template or spec-drafting state', () {
      final decoded =
      ...
      for (final item in features) {
        ...
        expect(legend, contains(feature['status']));
      }
    });
    ...
    test('canonical UI map is generated from approved spec deltas', () async {
      ...
      final hasApprovedSpec = features.any((feature) {
        return approvedStatuses.contains(feature['status']) &&
